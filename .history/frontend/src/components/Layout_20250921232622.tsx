...
const Layout: React.FC<LayoutProps> = ({ children }) => {
  ...
  return (
    <div className="flex h-screen bg-gray-100 dark:bg-gray-900">
      {/* Enhanced Sidebar */}
      <div className={`fixed inset-y-0 left-0 z-50 w-72 transform bg-gradient-to-b from-indigo-900 to-purple-800 dark:bg-gray-900 transition-transform duration-300 ease-in-out lg:static lg:translate-x-0 ${isSidebarOpen ? 'translate-x-0' : '-translate-x-full'}`}>
        {/* Sidebar header with logo */}
        <div className="flex items-center justify-between h-20 px-6 bg-gradient-to-r from-purple-800 to-indigo-800 shadow-lg">
        ...
        {/* Sidebar footer */}
        <div className="absolute bottom-0 w-full px-6 py-4 border-t border-indigo-700/50">
