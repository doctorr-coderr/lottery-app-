...
const Notifications: React.FC = () => {
  ...
  const fetchNotifications = async () => {
    try {
      const response = await api.get('/notifications'); // Changed from '/users/notifications'
  ...
  const markAsRead = async (id: string) => {
    try {
      await api.patch(`/notifications/${id}/read`); // Changed from '/users/notifications'
  ...
  const markAllAsRead = async () => {
    try {
      await api.patch('/notifications/read-all'); // Changed from '/users/notifications'
