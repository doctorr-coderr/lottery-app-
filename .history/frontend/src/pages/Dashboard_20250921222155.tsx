  ...
  return (
    <div>
      <div className="grid grid-cols-2 gap-6 mb-8 md:grid-cols-3">
        {/* Balance Card */}
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6 pb-4">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-xl lg:text-2xl font-bold text-gray-900 dark:text-white">ETB {balance}</p>
            </div>
          </div>
        </div>
