      ...
      <div className="grid grid-cols-2 gap-6 mb-8 md:grid-cols-3">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <h2 className="text-[20px] lg:text-lg font-semibol text-gray-800 dark:text-white">Current Balance</h2>
              <p className="text-2xl font-bold text-gray-900 dark:text-white">ETB {balance}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <h2 className="text-lg font-semibold text-gray-800 dark:text-white">Upcoming Draws</h2>
              <p className="text-2xl font-bold text-gray-900 dark:text-white">{upcomingDraws.length}</p>
            </div>
          </div>
        </div>
