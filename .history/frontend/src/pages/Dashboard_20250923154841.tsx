...
const Dashboard: React.FC = () => {
  ...
  <div className="fixed bottom-6 right-6 z-50">
    <button
      ...
      className="bg-purple-400 hover:bg-purple-600 text-white w-14 h-14 rounded-full flex items-center justify-center shadow-lg hover:shadow-xl transition-all"
