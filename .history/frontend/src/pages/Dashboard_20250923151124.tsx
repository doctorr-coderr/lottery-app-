    ...
    <div className="space-y-6">
     {/* Winners Celebration Banner */}
      {recentWinners.length > 0 && currentWinner && (
        <div className="relative w-[520px] mx-[-30px] lg:w-full lg:mx-auto bg-gradient-to-r from-yellow-400 via-orange-500 to-red-500 rounded-xl shadow-2xl text-white p-6
        pt-0 overflow-hidden border-4 border-yellow-300 transform transition-all duration-500 hover:scale-[1.01]">
