      ...
      <div className="grid grid-cols-2 gap-6 mb-8 md:grid-cols-3">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-[22px] lg:text-2xl font-bold text-green-600 dark:text-green-600">ETB {balance}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <h2 className="text-sm lg:text-lg text-gray-800 dark:text-white">Upcoming Draws</h2>
              <p className="text-xl lg:text-2xl font-bold text-indigo-600 dark:text-yellow-500">{upcomingDraws.length}</p>
            </div>
          </div>
        </div>
