  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
      ...
      <div className="lg:col-span-1 space-y-6">
        <div className="bg-gray-900 rounded-2xl shadow-xl p-6 flex flex-col items-center text-center">
          <div className="w-20 h-20 rounded-full bg-gradient-to-r from-blue-500 to-purple-600 flex items-center justify-center text-white text-3xl font-bold">
            {user?.id?.charAt(0).toUpperCase() || <User />}
          </div>
          <h2 className="mt-4 text-white text-lg font-semibold">{user?.id}</h2>
          <p className="text-gray-400 text-sm">Member since 2025</p>
          <button className="mt-4 px-4 py-2 rounded-xl bg-gradient-to-r from-blue-500 to-purple-600 text-white hover:opacity-90 transition">
            Deposit Funds
          </button>
        </div>
