    ...
    <div className="relative z-10 flex flex-col items-center space-y-5">
      ...
      <div className="relative bg-white/10 backdrop-blur-sm rounded-xl p-5 w-full max-w-md text-center border border-white/20 shadow-lg transform transition-all duration-300 hover:scale-105">
        ...
        <div className="text-sm opacity-80 mb-2">
          in Draw #{currentWinner.draw?.id?.slice(-6) || '------'}
        </div>
      ...
      <div className="text-center mt-2 relative">
        ...
        {/* Prize Badge */}
        <div className="inline-block mt-2 bg-gradient-to-r from-green-500 to-emerald-600 text-white text-xs font-bold px-3 py-1 rounded-full">
          💰 JACKPOT 💰
        </div>
      </div>
