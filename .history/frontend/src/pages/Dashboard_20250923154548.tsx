...
import { Clock, Wallet, Target } from 'lucide-react';
...
const Dashboard: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
     {/* Winners Celebration Banner */}
      ...
      {/* Sticky Rules Button */}
    <div className={`absolute bottom-16 right-0 w-64 bg-white dark:bg-gray-800 shadow-lg rounded-lg p-4 text-sm text-gray-800 dark:text-gray-200 transform transition-all duration-300 ${showRules ? 'scale-100 opacity-100' : 'scale-95 opacity-0'}`}>

  <button
    onClick={() => setShowRules((prev) => !prev)}
    className="bg-blue-600 hover:bg-blue-700 text-white w-14 h-14 rounded-full flex items-center justify-center shadow-lg hover:shadow-xl transition-all"
  ...
  {/* Tooltip / Mini Modal */}
  {showRules && (
    <div className="absolute bottom-16 right-0 w-64 bg-white dark:bg-gray-800 shadow-lg rounded-lg p-4 text-sm text-gray-800 dark:text-gray-200">
