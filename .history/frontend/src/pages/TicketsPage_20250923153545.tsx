...
const calculatePotentialWin = (draw: Draw & { ticketCount?: number }) => {
  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      <div className="bg-blue-50 dark:bg-gray-800 rounded-lg shadow p-9 mx-[-40px] mb-[-30px]">
        <h3 className="text-xl font-bold text-gray-800 dark:text-white mb-4">My Tickets</h3>
        {tickets.length > 0 ? (
          <div className="overflow-x-auto">
            <table className="min-w-[120%] divide-y divide-gray-200 dark:divide-gray-700">
