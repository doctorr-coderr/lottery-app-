    ...
    <div className="space-y-6">
     {/* Winners Celebration Banner */}
      {recentWinners.length > 0 && currentWinner && (
        <div className="relative w-[520px] mx-[-32px] lg:w-full lg:mx-auto bg-gradient-to-r from-yellow-400 via-orange-500 to-red-500 rounded-xl shadow-2xl text-white p-6 overflow-hidden  transform transition-all duration-300 hover:scale-[1.01]">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          {/* Next Draw Highlight */}
          {nextDraw && (
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow mx-[-30px]">
              <div className="px-7 py-4 border-b border-gray-200 dark:border-gray-700">
        ...
        <div className="space-y-6">
          {/* Recent Winners */}
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow mx-[-30px] lg:mx-auto">
          ...
          {/* Call to Action */}
          <div className="bg-gradient-to-r from-blue-500 to-purple-600 rounded-lg shadow-lg text-white p-6 text-center mx-[-30px] md:mx-auto lg:mx-auto">
      ...
      <div>
        <p className='text-gray-600 text-md font-semibold text-center'>
          © 2025 LuckyDraw All rights reserved.
        </p>
      </div>
  ...
  {showRules && (
    <div className="absolute bottom-16 right-0 w-96 bg-white dark:bg-gray-700 shadow-lg rounded-lg p-4 text-sm text-gray-800 dark:text-gray-200">
      ...
      <button
        ...
        className="mt-3 text-red-500 hover:underline text-lg"
      >
        Close
      </button>
    </div>
