  ...
  return (
    <div className="space-y-6">
      ...
      {recentWinners.length > 0 && currentWinner && (
        <div className="w-[520px] mx-[-30px] lg:w-full lg:mx-auto bg-gradient-to-r from-yellow-400 via-orange-500 to-red-500 rounded-lg shadow-lg text-white p-4 relative overflow-hidden">
          {/* Decorative emojis */}
